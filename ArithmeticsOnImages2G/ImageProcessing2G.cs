...
namespace SkyImagesAnalyzerLibraries2G
{
    ...
    /// </summary>
    public class ImageProcessing2G
    {
        /// <summary>
        ...
        public ImageProcessing2G(Bitmap inBM)
        {
        ...
        public ImageProcessing2G(Bitmap inBM, bool whetherHaveToCalculateAllSignificantMasksImmediately = false)
        {
            //bm2Process = (Bitmap)inBM.Clone();
            img2process = new Image<Bgr, byte>(inBM);
        ...
        public ImageProcessing2G(Image<Bgr, byte> inImg, bool whetherHaveToCalculateAllSignificantMasksImmediately = false)
        {
        ...
        public ImageProcessing2G(Image<Bgr, byte> inImg, RoundData predefinedRoundedMask = null)
        {
            //bm2Process = ServiceTools.CopyBitmap(inImg.Bitmap);
            img2process = inImg.Copy();
            overallImageArea = (double)img2process.Width * (double)img2process.Height;
        ...
        {
            ArithmeticsOnImages2G aoi = new ArithmeticsOnImages2G();
            ...
            aoi.RPNeval();
            ServiceTools2G.FlushMemory(tbLog, "");
        ...
        public static Tuple<double, double, ImageProcessing2G> CalculateMedianPerc5Values(string strFullFilePath, int MaxImageSize = 0)
        {
            Tuple<double, double, ImageProcessing2G> retTpl;
            ...
            if (MaxImageSize != 0)
            {
                currImg = ImageProcessing2G.ImageResizer(currImg, MaxImageSize);
            }
            ImageProcessing2G imgP = new ImageProcessing2G(currImg, true);
            DenseMatrix dmGrixData = imgP.eval("grix", null);
            Image<Gray, Byte> maskImageCircled = imgP.imageSignificantMaskCircled();
            DenseMatrix dmMaskCircled100 = ImageProcessing2G.DenseMatrixFromImage(maskImageCircled);
            ...
            retTpl = new Tuple<double, double, ImageProcessing2G>(median, perc5, imgP);
