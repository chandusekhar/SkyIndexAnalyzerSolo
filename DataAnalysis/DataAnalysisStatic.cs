...
{
    public static class DataAnalysisStatic
    {
        ...
        public static DenseMatrix CartesianToPolar(DenseMatrix dmData, PointD centerPoint, DenseMatrix dmMask, int angleGridNodesCount = 144)
        {
            ...
            foreach (Tuple<int, MathNet.Numerics.LinearAlgebra.Vector<double>> tplRowVectorAndIndex in dmOutData.EnumerateRowsIndexed())
            {
                ...
                DenseVector currVectorSmoothed = currVector.Conv(Extensions.StandardConvolutionKernels.gauss, 5);
        ...
        public static DenseVector MeansPerColumns(DenseMatrix dmSrc)
        {
            return StatPerColumns(dmSrc, Statistics.Mean);
        }




        public static DenseVector MeansPerRows(DenseMatrix dmSrc)
        {
            return StatPerRows(dmSrc, Statistics.Mean);
        }



        public static DenseVector STDperColumns(DenseMatrix dmSrc)
        {
            return StatPerColumns(dmSrc, Statistics.StandardDeviation);
        }




        public static DenseVector STDPerRows(DenseMatrix dmSrc)
        {
            return StatPerRows(dmSrc, Statistics.StandardDeviation);
        }
        ...
        public static DenseVector StatPerColumns(DenseMatrix dmSrc, Converter<IEnumerable<double>, double> converter)
        {
            DenseVector dvRetVal =
                DenseVector.OfEnumerable(dmSrc.EnumerateColumns().ToList().ConvertAll(converter));
        ...
        public static DenseVector StatPerRows(DenseMatrix dmSrc, Converter<IEnumerable<double>, double> converter)
        {
            DenseVector dvRetVal =
                DenseVector.OfEnumerable(dmSrc.EnumerateRows().ToList().ConvertAll(converter));
