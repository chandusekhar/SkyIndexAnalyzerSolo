...
namespace PdfFileWriter
{
    public class PdfImage : PdfObject
    {
        ...
        private Bitmap theBitmapImage;

        ////////////////////////////////////////////////////////////////////
        // Constructor
        ////////////////////////////////////////////////////////////////////

        public PdfImage(PdfDocument Document, String ImageFileName)
        ...
        internal override void WriteObjectToPdfFile(BinaryWriter PdfFile)
        {
            if (ImageFileName == null)
            {
                ...
                else
                {
                    ...
                    ImageConverter converter = new ImageConverter();
                    byte[] imageBuffer = (byte[])converter.ConvertTo(theBitmapImage, typeof(byte[]));
                    PdfFile.Write(imageBuffer, 0, imageBuffer.Length);


                    // convert stream to binary writer
                    //using (BinaryReader ImageFile = new BinaryReader(new FileStream(TempFileName, FileMode.Open, FileAccess.Read, FileShare.None), Encoding.UTF8))
                    //{
