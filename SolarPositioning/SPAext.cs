...
namespace SolarPositioning
{
    public class SPAext
    {
        public spa_data spa = new spa_data();
        ...
        public static double[][][] L_TERMS = SPA.TERMS_L;
        public static double[][][] B_TERMS = SPA.TERMS_B;
        public static double[][][] R_TERMS = SPA.TERMS_R;
        public static double[][] Y_TERMS = SPA.TERMS_Y;
        public static double[][] PE_TERMS = SPA.TERMS_PE;
        ...
        public SPAext(
            ...
            SpaExtFunctionType spa_function = SpaExtFunctionType.SPA_ALL)
        {
        ...
        int validate_inputs(spa_data spa)
        {
            ...
            if ((spa.function == SpaExtFunctionType.SPA_ZA_INC) || (spa.function == SpaExtFunctionType.SPA_ALL))
            {
        ...
        void nutation_longitude_and_obliquity(double jce, double[] x, double del_psi, double del_epsilon)
        {
            int i;
        ...
        public int spa_calculate()
        {
            ...
            if (result == 0)
            {
                ...
                if ((spa.function == SpaExtFunctionType.SPA_ZA_RTS) || (spa.function == SpaExtFunctionType.SPA_ALL))
    ...
    public enum SpaExtFunctionType
    {
    ...
    public struct spa_data
    {
        ...
        public SpaExtFunctionType function;        // Switch to choose functions for desired output (from enumeration)
