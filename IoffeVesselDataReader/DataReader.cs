...
namespace IoffeVesselDataReader
{
    ...
    public class IoffeVesselMeteoDataReader
    {
        ...
        public static IoffeVesselMetDataConverted GetMetDataByDatetime(string metDataFilesPath, DateTime dt)
        {
            ...
            {
                Tuple<DateTime, DateTime> timeSpan =
                    IoffeVesselMeteoDataReader.GetMetFileDateTimeMargins(metFilename);
                if (timeSpan == null)
                {
                    continue;
                }
                ...
                List<IoffeVesselMetDataConverted> dataHasBeenRead = IoffeVesselMeteoDataReader.ReadMetFile(metFilename);
                if (dataHasBeenRead == null)
                {
                    continue;
                }
